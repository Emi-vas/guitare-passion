    ...
    return (
                <div className='articlePage'>
                    ...
                    <div className='blocVideo'>
                        <iframe  src={articleData.video} title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" ></iframe>
                    </div>
                </div>
    );
};
